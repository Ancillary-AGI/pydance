/**
 * WebSocketClient - Real-time Communication with Pydance Backend
...
export class WebSocketClient {
  ...
  emit(event, data) {
    ...
    if (typeof window !== 'undefined') {
      window.dispatchEvent(new CustomEvent(`pydance:ws:${event}`, { detail: data }));
    }
  }
  ...
  destroy() {
    ...
    if (typeof window !== 'undefined') {
      ...
      events.forEach(event => {
        window.removeEventListener(`pydance:ws:${event}`, () => {});
      });
    }
  }
}
