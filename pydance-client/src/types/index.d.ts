/**
 * Pydance Client - TypeScript Type Definitions
 * Comprehensive type definitions for the Pydance Client framework
 */
...
export interface PydanceClientFramework {
...
declare global {
  interface Window {
    PydanceClient: PydanceClientFramework;
    __PYDANCE_ROUTER__: Router;
    __PYDANCE_AUTH__: Auth;
    __PYDANCE_NOTIFICATIONS__: NotificationManager;
    __PYDANCE_THEME__: ThemeManager;
    __PYDANCE_CACHE__: CacheManager;
    __PYDANCE_WS__: WebSocketClient;
    __PYDANCE_PERFORMANCE__: PerformanceMonitor;
    __PYDANCE_MEMORY__: MemoryManager;
    __PYDANCE_ADVANCED_DIFFER__: AdvancedDiffer;
  }
