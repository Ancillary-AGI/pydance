...
export class JSXElementFactory {
  ...
  isElement(value) {
    return value && typeof value === 'object' &&
           value.$$typeof === Symbol.for('pydance.element');
  }

  // Check if value is fragment
  isFragment(value) {
    return value && typeof value === 'object' &&
           value.$$typeof === Symbol.for('pydance.fragment');
  }
}
...
export class JSXOptimizer {
  ...
  optimize(element) {
    ...
    if (element.$$typeof === Symbol.for('pydance.element')) {
      return this.optimizeElement(element);
    }

    if (element.$$typeof === Symbol.for('pydance.fragment')) {
