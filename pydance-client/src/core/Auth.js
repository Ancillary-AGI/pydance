/**
 * Auth - Authentication System for Pydance Client Framework
 * Provides comprehensive authentication management with token handling,
 * session management, and seamless integration with Pydance backend
 */
...
export class Auth {
  constructor(config = {}) {
    this.config = {
      ...
      storageKey: config.storageKey || 'pydance_auth',
...
export function useAuth() {
  return window.__PYDANCE_AUTH__;
}
