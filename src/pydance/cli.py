...
class PydanceCLI:
  ...
  pydance test
    ...
    def _add_project_commands(self, subparsers):
        ...
        startproject_parser = subparsers.add_parser('startproject', help='Create a new Pydance project')
        ...
        startapp_parser = subparsers.add_parser('startapp', help='Create a new Pydance app')
    ...
    def _add_system_commands(self, subparsers):
        ...
        subparsers.add_parser('version', help='Show Pydance version')
    ...
    def cmd_start(self, args):
        ...
        env = os.environ.copy()
        env['PYDANCE _HOST'] = args.host
        env['PYDANCE _PORT'] = str(args.port)
        env['PYDANCE _WORKERS'] = str(args.workers)
        env['PYDANCE _RELOAD'] = '1' if args.reload else '0'
        env['PYDANCE _DEBUG'] = '1' if args.debug else '0'
    ...
    def cmd_migrate(self, args):
        ...
        import asyncio
        from pydance.migrations.framework import migrate_app, check_migration_status
...
''')
    ...
    def cmd_version(self, args):
        ...
        try:
            from pydance import __version__
