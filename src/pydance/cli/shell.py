...
class PydanceShell:
    """
    Interactive Python shell with Pydance context pre-loaded.
    ...
    def start_shell(self):
        ...
        print("- app: Pydance application instance")
            ...
            if os.path.exists(models_dir):
                for filename in os.listdir(models_dir):
                    if filename.endswith('.py') and not filename.startswith('__'):
                        ...
                        try:
                            module = __import__(f'pydance.models.{module_name}', fromlist=[module_name])
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Pydance Shell Commands")
