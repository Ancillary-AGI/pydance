...
async def render_template_string_async(source: str, **context) -> str:
    ...
    # Add event loop check for compatibility
    try:
        loop = asyncio.get_running_loop()
        # For simple templates, sync rendering is fast enough
...
async def render_template_file_async(path: Union[str, Path], **context) -> str:
