"""
Throttle Middleware for Pydance Framework.

This middleware provides customizable rate limiting using the Pydance rate limiter.
...
class ThrottleMiddleware(HTTPMiddleware):
    """
    Customizable throttle middleware using Pydance rate limiter.
